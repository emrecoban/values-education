...
if request.ServerVariables("REQUEST_METHOD")="POST" then
	if request.Form("ad")<>"" and request.Form("soyad")<>"" and request.Form("username")<>"" and request.Form("password")<>"" and request.Form("mail")<>"" and request.Form("kota")<>"" then
        ...
        <%
			...
			YeniOgr("kota_k")=request.Form("kota")
			YeniOgr.Update
			%>
			<script type="text/javascript">
            ...
            <div class="contentpanel">
                <div class="contenttitle">
                  <table width="698" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="349" align="left" valign="middle">Yeni Öğretmen</td>
                ...
                <div class="contentbox">
                      ...
                      <table width="696" border="0" cellspacing="1" cellpadding="0">
                        ...
                        <tr bgcolor="#CAEDFF">
                          ...
                          <td height="30" align="left" valign="middle"><input type="text" name="kota" class="formtext" onKeyUp="onlyNum(this);" /></td>
                        </tr>
                        <tr>
